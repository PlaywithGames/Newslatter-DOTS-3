...
namespace Object_Pool_Job
{
    public class PoolInfoSetsManager : MonoBehaviour
    {
        ...
        private Dictionary<string, PoolInfoSets> m_container = new Dictionary<string, PoolInfoSets>(300);
        ...
        void Start()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                Push(projectile, eStoreType.TIMER_DESTROY, ePoolInfoType.Bundle, 1);
            }
        ...
        public void Push<T>(T _ob, eStoreType _storeType, ePoolInfoType _poolInfoType = ePoolInfoType.none, System.Int32 setLayer = -1) where T : Component
        {
            if (_ob == null)
            {
                return;
        ...
        public void Push(GameObject _ob, eStoreType _storeType, ePoolInfoType _poolInfoType = ePoolInfoType.none, System.Int32 setLayer = -1)
        {
            if(_ob == null)
            {
                return;
            ...
            {
                m_container.Add(_obName, new PoolInfoSets(_obName, this.transform, m_Bundle.transform));
            }
